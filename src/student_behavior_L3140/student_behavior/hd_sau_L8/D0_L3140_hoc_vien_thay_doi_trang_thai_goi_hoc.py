...
def etl_hoc_viec_kich_hoat_goi_hoc():
    dyf_tig_market=connectGlue(database="tig_market",table_name="tpe_enduser_used_product_history",
                                    ...
                                    fillter=["contact_id","timecreated"],
    ...
    df_kich_hoat_goi_hoc= df_tig_market_contact.join(df_contact_crm_native,
                                        (df_tig_market_contact["contact_id"] == df_contact_crm_native["Code"]),"left")
    df_kich_hoat_goi_hoc=df_kich_hoat_goi_hoc.drop("Code","contact_id_contact")


    prinDev(df_kich_hoat_goi_hoc,"df_khoa_hoc_contact")
    # -----------------------------------------------------------------------------------------------------------------#
    ...
    df_join_level_code = set_package_advisor_level(df_kich_hoat_goi_hoc)
    for k, v in ADD_COLLUM.items():
