...
def etl_dang_ki_tai_khoan():
    ...
    try:
        ...
        dyf_lms_user = Filter.apply(frame=dyf_lms_user, f=lambda x: x["_key"] > max_key)
    except:
    ...
    if dyf_lms_user > 0:
        ...
        df_lms_user = dyf_lms_user.toDF()
        df_lms_user_contact = df_lms_user.join(df_student_contact,
                                               df_lms_user["student_id"]==df_student_contact["student_id_contact"],"left")
        ...
        # ghi de _key vao s3
        df.write.parquet("s3a://toxd-olap/transaction_log/flag/flag_behavior_hoc_vien_nhap_hoc.parquet",
                         mode="overwrite")
