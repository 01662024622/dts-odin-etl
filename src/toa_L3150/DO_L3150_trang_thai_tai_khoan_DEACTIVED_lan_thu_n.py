...
def main():
    ...
    # try:
    #     df_flag = spark.read.parquet("s3://dtsodin/flag/flag_trang_thai_tai_khoan_deactived_lan_n.parquet")
    ...
    if dyf_tpe_enduser_used_product_history.count() > 0:
        try:
            ...
            df_part_one = df_part_one.join(df_tpe_enduser_used_product_history,
                                           ...
                                           & (df_part_one.used_product_id_temp == df_tpe_enduser_used_product_history.used_product_id))
            ...
            df_join_deactived_status = df_join_deactived_status \
                ...
                .withColumn("to_status_id", f.lit(210).cast("long")) \
            ...
            # ghi de _key vao s3
            df.write.parquet("s3a://dtsodin/flag/flag_trang_thai_tai_khoan_deactived_lan_n.parquet", mode="overwrite")
