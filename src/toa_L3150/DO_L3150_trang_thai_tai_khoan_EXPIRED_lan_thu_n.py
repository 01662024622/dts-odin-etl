...
def main():
    ...
    if dyf_tpe_enduser_used_product_history.count() > 0:
        try:
            ...
            ######################################
            ######## START cancelled
            dyf_join_cancelled_status = Filter.apply(frame=dyf_join_part_one_contact,
            ...
            dyf_join_cancelled_status = DynamicFrame.fromDF(df_join_cancelled_status, glueContext,
            ...
            ######## START expired
            dyf_join_expired_status = Filter.apply(frame=dyf_join_part_one_contact,
            ...
            dyf_join_expired_status = DynamicFrame.fromDF(df_join_expired_status, glueContext,
            ...
            df_join_expired_status = df_join_expired_status.withColumn("user_id", f.lit(None).cast("long"))

            dyf_join_status = DynamicFrame.fromDF(df_join_expired_status, glueContext, "dyf_join_status")
            ...
            datasink1 = glueContext.write_dynamic_frame.from_jdbc_conf(frame=dropnullfields1,
                                                                       ...
                                                                       redshift_tmp_dir="s3a://dtsodin/temp/mapping_changed_status_student_temp/",
            ...
            # ghi de _key vao s3
            df.write.parquet("s3a://dtsodin/flag/flag_trang_thai_tai_khoan_expired_lan_n.parquet", mode="overwrite")
