...
def get_weekend_timestamp(year_month_id):
    date_time = datetime.strptime(str(year_month_id), "%Y%W")
...
def main():
    ...
    # ------------------------------------------------------------------------------------------------------------------#
    # test something
    # glueContext, start_year_month_id, end_year_month_id
    # get_ls_sc_lt_student_lerning_and_duration(glueContext, start_year_month_id, end_year_month_id)
    # return
    # =============
    ...
    dyf_student_package_week = DynamicFrame \
        .fromDF(df_student_package_week, glueContext,
                'dyf_student_package_week')

    datasink4 = glueContext.write_dynamic_frame.from_jdbc_conf(
        frame=dyf_student_package_week,
        catalog_connection="glue_redshift",
        connection_options={
            "dbtable": "bc200.dyf_student_package_week",
            "database": "student_native_report",
        },
        redshift_tmp_dir="s3n://dts-odin/temp/thanhtv3/dyf_student_package_status_by_date_learning_ls_sc_lt_2",
        transformation_ctx="datasink4")


    #-------------------------------------------------------------------------------------------------------------------#

    df_student_level_week = convert_start_end_to_week_id(df_student_level)
    ...
    #        & (df_student_package_week.week_id >= df_student_level_week.start_week_id)
    #        & (df_student_package_week.week_id < df_student_level_week.end_week_id),
    #     how='inner'
    # )

    df_student_package_week = df_student_package_week\
        .withColumn('weekend_timestamp', get_weekend_timestamp('week_id'))

    df_student_package_status_by_date = df_student_package_week.join(
        df_student_level_week,
        on=(df_student_package_week.contact_id == df_student_level_week.contact_id_level)
           & (df_student_package_week.weekend_timestamp >= df_student_level_week.start_date)
           & (df_student_package_week.weekend_timestamp < df_student_level_week.end_date),
        how='inner'
    )
    ...
    # if is_dev:
    #     print ('df_student_package_status_by_date')
    #     df_student_package_status_by_date.printSchema()
    #     df_student_package_status_by_date.show(3)

    df_ls_sc_lt_total_student_learning_and_duration = \
        get_ls_sc__lt_total_student_lerning_and_duration(glueContext, start_year_month_id, end_year_month_id)
    if is_dev:
        print ('df_ls_sc_lt_total_student_learning_and_duration')
        df_ls_sc_lt_total_student_learning_and_duration.printSchema()
        df_ls_sc_lt_total_student_learning_and_duration.show(3)

    df_student_package_status_by_date_learning_ls_sc_lt = df_student_package_status_by_date \
        .join(df_ls_sc_lt_total_student_learning_and_duration,
              on=['contact_id', 'week_id'],
              how='left') \
        .na.fill({'total_learning_ls_sc_lt_week': 0L,
    ...
    # | -- total_learning_ls_sc_week: long(nullable=false)
    # | -- total_number_ls_sc_success_week: long(nullable=true)
    # | -- total_duration_ls_sc_week: long(nullable=true)

    if is_dev:
        print ('df_student_package_status_by_date_learning_ls_sc_lt')
        df_student_package_status_by_date_learning_ls_sc_lt.printSchema()
        df_student_package_status_by_date_learning_ls_sc_lt.show(3)

    dyf_student_package_status_by_date_learning_ls_sc_lt = DynamicFrame \
        .fromDF(df_student_package_status_by_date_learning_ls_sc_lt, glueContext,
                'dyf_student_package_status_by_date_learning_ls_sc_lt')

    if is_dev:
        print ('dyf_student_package_status_by_date_learning_ls_sc_lt')
        dyf_student_package_status_by_date_learning_ls_sc_lt.printSchema()
        dyf_student_package_status_by_date_learning_ls_sc_lt.show(3)

    datasink4 = glueContext.write_dynamic_frame.from_jdbc_conf(
        frame=dyf_student_package_status_by_date_learning_ls_sc_lt,
        catalog_connection="glue_redshift",
        connection_options={
            "dbtable": "bc200.dyf_student_package_status_by_date_learning_ls_sc_lt_2",
            "database": "student_native_report",
        },
        redshift_tmp_dir="s3n://dts-odin/temp/thanhtv3/dyf_student_package_status_by_date_learning_ls_sc_lt_2",
        transformation_ctx="datasink4")
    ...
    # | -- package_id: long(nullable=true)
    # | -- package_status_id: long(nullable=true)
    # | -- contact_id_level: string(nullable=true)
    # | -- student_level_id: long(nullable=true)
    # | -- start_week_id: long(nullable=true)
    # | -- end_week_id: long(nullable=true)
    # | -- total_learning_ls_sc_week: long(nullable=false)
    # | -- total_number_ls_sc_success_week: long(nullable=true)
    # | -- total_duration_ls_sc_week: long(nullable=true)
    ...
    df_student_package_status_by_date_learning_ls_sc_lt = df_student_package_status_by_date_learning_ls_sc_lt \
        .select(
        'week_id', 'package_id', 'student_level_id',
        'contact_id',
        is_active('package_status_id').alias('is_active'),
        f.when(df_student_package_status_by_date_learning_ls_sc_lt.total_learning_ls_sc_lt_week > 0L, 1L).otherwise(0L)
            .alias('is_ls_sc_lt'),
        f.when(df_student_package_status_by_date_learning_ls_sc_lt.total_learning_ls_sc_lt_success_week > 0L,
               1L).otherwise(0L)
            .alias('is_ls_sc_lt_success'),
        ...
        f.when(df_student_package_status_by_date_learning_ls_sc_lt.total_learning_ls_success_week > 0L,
               1L).otherwise(0L)
            .alias('is_ls_success'),

        f.when(df_student_package_status_by_date_learning_ls_sc_lt.total_learning_sc_success_week > 0L,
               1L).otherwise(0L)
            .alias('is_sc_success'),

        f.when(df_student_package_status_by_date_learning_ls_sc_lt.total_learning_lt_success_week > 0L,
               1L).otherwise(0L)
            .alias('is_lt_success'),
    ...
    df_student_package_status_group_week = df_student_package_status_by_date_learning_ls_sc_lt \
        .groupBy('week_id', 'package_id', 'student_level_id').agg(
        f.count('contact_id').alias('total_student'),
    ...
    print('df_student_package_status_group_week')
    df_student_package_status_group_week.printSchema()
    df_student_package_status_group_week.show(3)

    dyf_student_package_status_group_week = DynamicFrame \
        .fromDF(df_student_package_status_group_week, glueContext, 'dyf_student_package_status_group_week')
    ...
    glueContext.write_dynamic_frame.from_jdbc_conf(frame=dfy_output,
                                                   catalog_connection="glue_redshift",
                                                   connection_options={
                                                       #"preactions": """TRUNCATE TABLE bc200.bc200_fact """,
                                                       "dbtable": "bc200.bc200_fact",
                                                       "database": "student_native_report"
                                                   },
                                                   redshift_tmp_dir="s3n://dts-odin/temp/bc200/bc200_fact",
                                                   transformation_ctx="datasink4")
